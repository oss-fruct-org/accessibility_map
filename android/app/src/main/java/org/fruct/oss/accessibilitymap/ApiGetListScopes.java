 ...
 *
 */
public class ApiGetListScopes extends AsyncTask<String, Void, Boolean> {
    ...
    public ApiGetListScopes(Context context) {
        this.context = context;

        b = Uri.parse(Constants.API_SERVICE_URL+ "getListScopes").buildUpon();

        requestUrl = b.build().toString();

        Log.d("accmap getlistscopes", requestUrl);
    }

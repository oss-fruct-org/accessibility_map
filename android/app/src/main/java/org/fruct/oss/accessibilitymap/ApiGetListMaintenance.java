 ...
 *
 */
public class ApiGetListMaintenance extends AsyncTask<String, Void, Boolean> {
    ...
    public ApiGetListMaintenance(Context context) {
        this.context = context;

        b = Uri.parse(Constants.API_SERVICE_URL+ "getListMaintenanceForms").buildUpon();

        requestUrl = b.build().toString();

        Log.d("accmap getListMaintenanceForms", requestUrl);
    }

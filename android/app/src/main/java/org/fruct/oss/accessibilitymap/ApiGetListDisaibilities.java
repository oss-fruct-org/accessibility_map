 ...
 *
 */
public class ApiGetListDisaibilities extends AsyncTask<String, Void, Boolean> {
    ...
    public ApiGetListDisaibilities(Context context) {
        this.context = context;

        b = Uri.parse(Constants.API_SERVICE_URL+ "getListDisabilities").buildUpon();

 ...
 *
 */
public class ApiGetListAccessibilities extends AsyncTask<String, Void, Boolean> {
    ...
    public ApiGetListAccessibilities(Context context) {
        this.context = context;

        b = Uri.parse(Constants.API_SERVICE_URL+ "getListAccessibilities").buildUpon();

        requestUrl = b.build().toString();

        Log.d("accmap getlistsdisabilities", requestUrl);
    }
